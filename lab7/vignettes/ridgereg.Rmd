...
Fit a linear regression model with forward selection on the training dataset as well.
```{r}
...
Include the custom method for "ridge regression"
```{r, eval=FALSE}
...
Fit a ridge regression for the training dataset.
```{r}
