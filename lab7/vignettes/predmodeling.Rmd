...
```
Now the dataset contains all relevant variables. 
This dataset is now scaled down and then divided into a training, validation and testing dataset.
```{r}
...
#
```
The data has now been devided into the training, validation and testing dataset.
```{r}
